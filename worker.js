...
function genQ2(grade) {
  const BANK_R2 = {
    P4: [
      {poem:'【成語填充】',text:'他上課時非常專心，總是＿＿＿＿地聽老師講課。',options:["一心一意"],answer:0},
      {poem:'【成語填充】',text:'小明把事情經過＿＿＿＿地告訴老師。',options:["一五一十"],answer:0},
      {poem:'【成語填充】',text:'姐姐做事有條理，寫報告也＿＿＿＿。',options:["有條有理"],answer:0},
      {poem:'【成語填充】',text:'他做事常常＿＿＿＿，一下做這個，一下做那個。',options:["三心兩意"],answer:0},
      {poem:'【成語填充】',text:'同學們看魔術表演時都＿＿＿＿。',options:["目不轉睛"],answer:0},
      {poem:'【成語填充】',text:'大家想了很多方法，終於＿＿＿＿解決難題。',options:["千方百計"],answer:0},
      {poem:'【成語填充】',text:'這對雙胞胎長得＿＿＿＿。',options:["一模一樣"],answer:0},
      {poem:'【成語填充】',text:'弟弟看故事書看得＿＿＿＿，連吃飯也忘了。',options:["津津有味"],answer:0},
      {poem:'【成語填充】',text:'聽到這個消息後，大家都＿＿＿＿。',options:["大吃一驚"],answer:0},
      {poem:'【成語填充】',text:'老師提醒我們做事不能＿＿＿＿，要專心。',options:["三心兩意"],answer:0},
      {poem:'【成語填充】',text:'他平日準備充足，所以比賽時＿＿＿＿。',options:["胸有成竹"],answer:0},
      {poem:'【成語填充】',text:'同學們＿＿＿＿地舉手回答問題。',options:["不約而同"],answer:0},
      {poem:'【成語填充】',text:'只要努力練習，總有一天會＿＿＿＿。',options:["名列前茅"],answer:0},
      {poem:'【成語填充】',text:'這篇文章最後一句真是＿＿＿＿，十分精彩。',options:["畫龍點睛"],answer:0},
      {poem:'【成語填充】',text:'他做事太急，常常＿＿＿＿，把東西打翻。',options:["手忙腳亂"],answer:0},
      {poem:'【成語填充】',text:'妹妹把房間收拾得＿＿＿＿。',options:["一乾二淨"],answer:0},
      {poem:'【成語填充】',text:'他對老師的叮囑＿＿＿＿，一直記在心裡。',options:["念念不忘"],answer:0},
      {poem:'【成語填充】',text:'小華說話很直，總是＿＿＿＿。',options:["心直口快"],answer:0},
      {poem:'【成語填充】',text:'同學們合作無間，終於＿＿＿＿完成任務。',options:["一舉兩得"],answer:0},
      {poem:'【成語填充】',text:'他做事不慌不忙，顯得＿＿＿＿。',options:["從容不迫"],answer:0},
      {poem:'【成語填充】',text:'大家＿＿＿＿地討論這個有趣的問題。',options:["興高采烈"],answer:0},
      {poem:'【成語填充】',text:'他看見成績單後，高興得＿＿＿＿。',options:["手舞足蹈"],answer:0},
      {poem:'【成語填充】',text:'爸爸工作很忙，常常＿＿＿＿。',options:["早出晚歸"],answer:0},
      {poem:'【成語填充】',text:'老師一提醒，我立刻＿＿＿＿地改正錯誤。',options:["恍然大悟"],answer:0},
      {poem:'【成語填充】',text:'同學們比賽時都＿＿＿＿，不肯放棄。',options:["全力以赴"],answer:0},
      {poem:'【成語填充】',text:'這位同學平日＿＿＿＿，所以成績很好。',options:["勤學苦練"],answer:0},
      {poem:'【成語填充】',text:'看到這麼美麗的風景，大家都＿＿＿＿。',options:["讚不絕口"],answer:0},
      {poem:'【成語填充】',text:'他不小心打破花瓶，只好＿＿＿＿地承認。',options:["老老實實"],answer:0},
      {poem:'【成語填充】',text:'姐姐閱讀時十分投入，總是＿＿＿＿。',options:["聚精會神"],answer:0},
      {poem:'【成語填充】',text:'經過反覆練習，他終於＿＿＿＿地完成朗誦。',options:["流利順暢"],answer:0},
      {poem:'【排句成段】',text:'把句子排成一段通順的話： (1) 我連忙拿起雨傘走到校門口。 (2) 放學時忽然下起大雨。 (3) 媽媽已經在門外等我。 (4) 我們一起撐傘回家。',options:["2、1、3、4"],answer:0},
    ...
    P5: [
      {poem:'【成語填充】',text:'為了準備朗誦比賽，他每天都＿＿＿＿地練習。',options:["專心致志"],answer:0},
      {poem:'【成語填充】',text:'這篇作文內容已很完整，再加反而＿＿＿＿。',options:["畫蛇添足"],answer:0},
      {poem:'【成語填充】',text:'他看小說看得＿＿＿＿，連時間也忘了。',options:["津津有味"],answer:0},
      {poem:'【成語填充】',text:'做事不能＿＿＿＿，否則永遠難成功。',options:["半途而廢"],answer:0},
      {poem:'【成語填充】',text:'這次活動既學到知識，又玩得開心，真是＿＿＿＿。',options:["一舉兩得"],answer:0},
      {poem:'【成語填充】',text:'同學們看着舞台表演，都＿＿＿＿。',options:["目不轉睛"],answer:0},
      {poem:'【成語填充】',text:'全班＿＿＿＿地祝老師生日快樂。',options:["異口同聲"],answer:0},
      {poem:'【成語填充】',text:'面對突發情況，他依然＿＿＿＿。',options:["不慌不忙"],answer:0},
      {poem:'【成語填充】',text:'出發前先準備好雨具，真是＿＿＿＿。',options:["有備無患"],answer:0},
      {poem:'【成語填充】',text:'他前後說法不同，真是＿＿＿＿。',options:["自相矛盾"],answer:0},
      {poem:'【成語填充】',text:'因為事前已做好計劃，所以她報告時＿＿＿＿。',options:["胸有成竹"],answer:0},
      {poem:'【成語填充】',text:'科技發展＿＿＿＿，我們要不斷學習。',options:["日新月異"],answer:0},
      {poem:'【成語填充】',text:'爸爸做事＿＿＿＿，從不馬虎。',options:["一絲不苟"],answer:0},
      {poem:'【成語填充】',text:'這位球員在決賽中＿＿＿＿，表現出色。',options:["大顯身手"],answer:0},
      {poem:'【成語填充】',text:'他說話＿＿＿＿，讓人很難信服。',options:["振振有詞"],answer:0},
      {poem:'【成語填充】',text:'我們遇到困難也要＿＿＿＿，不要退縮。',options:["全力以赴"],answer:0},
      {poem:'【成語填充】',text:'這位同學平日勤奮，所以成績＿＿＿＿。',options:["名列前茅"],answer:0},
      {poem:'【成語填充】',text:'老師的解釋十分清楚，令我＿＿＿＿。',options:["豁然開朗"],answer:0},
      {poem:'【成語填充】',text:'同學們合作完成壁報，大家都＿＿＿＿。',options:["同心協力"],answer:0},
      {poem:'【成語填充】',text:'他的回答＿＿＿＿，十分流暢。',options:["對答如流"],answer:0},
      {poem:'【成語填充】',text:'這個方法用起來＿＿＿＿。',options:["得心應手"],answer:0},
      {poem:'【成語填充】',text:'只要不斷努力，就能＿＿＿＿。',options:["精益求精"],answer:0},
      {poem:'【成語填充】',text:'遇到問題時，我們可以＿＿＿＿，集合同學意見。',options:["集思廣益"],answer:0},
      {poem:'【成語填充】',text:'他做事＿＿＿＿，所以常常得到老師稱讚。',options:["有條不紊"],answer:0},
      {poem:'【成語填充】',text:'同學們對老師的照顧＿＿＿＿。',options:["念念不忘"],answer:0},
      {poem:'【成語填充】',text:'這位選手＿＿＿＿，很快就追回比分。',options:["後來居上"],answer:0},
      {poem:'【成語填充】',text:'大家聽到好消息後都＿＿＿＿。',options:["喜出望外"],answer:0},
      {poem:'【成語填充】',text:'這篇文章文字優美，令我＿＿＿＿。',options:["拍案叫絕"],answer:0},
      {poem:'【成語填充】',text:'他為人謙虛，從不＿＿＿＿。',options:["自高自大"],answer:0},
      {poem:'【成語填充】',text:'面對挑戰，我們要＿＿＿＿，奮勇向前。',options:["迎難而上"],answer:0},
    ...
    P6: [
      ...
      {poem:'【寓言故事】',text:'守在樹樁旁等兔子的故事，批評了甚麼？',options:["不肯努力，只想靠運氣"],answer:0},
      ...
      {poem:'【寓言故事】',text:'鄭人買鞋只信尺碼，不信自己的腳，這故事說明甚麼？',options:["拘泥成規，不知靈活變通"],answer:0},
